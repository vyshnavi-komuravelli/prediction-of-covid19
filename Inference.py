...
parser.add_argument('--trained_model_path', type=str, default='./covid_vgg16_epoch2.pt',
...
plt.figure()
pyplot.plot(ns_fpr_res18, ns_tpr_res18,  color='darkgreen', linewidth=2,   label='VGG16,        AUC= %.3f' %auc_res18)
pyplot.ylim([0,1.05])
