...
optimizer_conv = optim.SGD(model_conv.classifier[6].parameters(), lr=args.learning_rate, momentum=args.momentum)
...
if __name__ == "__main__":
    ...
    model_conv.eval()
    torch.save(model_conv, './covid_vgg16_epoch%d.pt' % args.epochs)
